...
Level.prototype.draw = function() {
	    Canvas.draw(this.sprite, this.position);
	    Canvas.draw_text(this.lev, {x:this.position.x+50,y:this.position.y+80}, "#C9513A", "Cinzel", "50px");
...
Level.prototype.update = function() {
  if((Mouse.position.x<this.position.x+this.sprite.width && Mouse.position.x >this.position.x && Mouse.position.y<this.position.y+this.sprite.height && Mouse.position.y>this.position.y) && (Mouse.left) && (this.lev <= Number(localStorage.level)) )
{
